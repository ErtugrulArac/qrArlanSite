    ...
    return (
        <div ref={ref}>
            ...
            <div className='text-white text-center mt-10   '>
                ...
                <p className='font-light w-[300px]  opacity-70 mt-5 tracking-wider max-md:text-xs max-md:mb-4'>Qr Menü sayesinde siparişlerinizi %17 artırın ve daha fazla gelir elde edin </p>
                <div className='h-[1px] w-[500px] bg-white mt-4 opacity-70 max-md:w-[98%] max-md:m-auto '></div>
            </div>
        </div>
    )
