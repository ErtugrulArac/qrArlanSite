...
const index = () => {
    return (
        <div className='flex justify-center items-center mt-32 gap-20  max-lg:flex-col max-md:mb-10'>
            <div className='text-white flex flex-col gap-5'>
                ...
                <p className='text-lg w-[600px] opacity-70 mt-8 max-xl:text-base max-xl:w-[400px] max-md:w-[90%] max-md:m-auto max-md:text-sm  '>
                    Sayısal verileri inceledik ve işletmeler, QR kodlu menülerle hem maliyet tasarrufu sağlayabilir hem de daha fazla gelir elde edebilir.
                </p>
            </div>
            <Yantaraf />
        </div>
