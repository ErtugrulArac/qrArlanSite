    ...
    return (
        <div className='flex justify-center items-center mt-32 gap-20  max-lg:flex-col max-md:mb-10 mb-16'>
            <div className='text-white flex flex-col gap-5'>
                <h3 className='text-5xl font-fontpopins font-bold w-[600px] max-xl:text-4xl max-xl:w-[400px] max-md:w-[90%] max-md:m-auto max-md:text-2xl'>Bir Qr Menüye Neden İhtiyacınız Var?</h3>
