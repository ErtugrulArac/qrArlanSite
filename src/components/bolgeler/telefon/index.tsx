        ...
        <div className='bg-white pb-20  '>
            <div className='w-[80%] m-auto flex max-lg:flex-col max-lg:w-full items-center justify-around max-lg:gap-14'>
                <div className='w-[40%] max-lg:w-[90%] flex flex-col gap-7 max-lg:gap-4'>
                    <h1 className='text-6xl max-lg:text-4xl  leading-[70px] w-full'>{header}</h1>
                    <p className='text-base max-lg:text-sm leading-[22px] opacity-80'>{text}</p>
                    <ul className='flex flex-col gap-4'>
                        <li className='flex gap-4 opacity-80 font-bold'><img src="koksal.svg" alt="" />{list[0]}</li>
                        <li className='flex gap-4 opacity-80 font-bold'><img src="koksal.svg" alt="" />{list[1]}</li>
                        <li className='flex gap-4 opacity-80 font-bold'><img src="koksal.svg" alt="" />{list[2]}</li>
                        <li className='flex gap-4 opacity-80 font-bold'><img src="koksal.svg" alt="" />{list[3]}</li>
                    </ul>
