        ...
        <div className='bg-white pt-20  '>
            <div className='w-[80%] m-auto flex max-lg:flex-col max-lg:w-full items-center justify-around max-lg:gap-14'>
                ...
                <div className='w-[40%] max-lg:w-[90%] flex flex-col gap-7 max-lg:gap-4'>
                    ...
                    <a title='qr menü info' className='w-max px-7 py-2 rounded-xl font-semibold bg-[#00af74] text-white whitespace-nowrap xl:text-lg mt-3' href="/"> Hemen Qr Menü Sahibi Olun</a>
                </div>
            </div>
        </div>
    )
