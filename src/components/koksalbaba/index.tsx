      ...
      <div className=' flex items-center justify-center    m-auto max-lg:flex-col max-lg:gap-16 max-lg:w-[70%] '>
        <div className='flex flex-col gap-10 max-md:gap-6'>
          ...
          <ul className='flex flex-col gap-3 mt-7 text-white'>
            ...
            <li className='flex items-center gap-2'>
              <img className='max-md:size-5' src="koksal.svg" alt="" /> <p className='text-xl font-medium  tracking-wide opacity-80 max-xl:text-lg max-md:text-base'>Seçtiğiniz qr teması ile birlikte kolayca bizle iletişime geçin.</p>
            </li>
            <li className='flex items-center gap-2'>
              <img className='max-md:size-5' src="koksal.svg" alt="" /> <p className='text-xl font-medium  tracking-wide opacity-80 max-xl:text-lg max-md:text-base'>Qr menü için gerekli işletme bilgilerini iletin.</p>

            </li>
            <li className='flex items-center gap-2'>
              <img className='max-md:size-5' src="koksal.svg" alt="" /> <p className='text-xl font-medium  tracking-wide opacity-80 max-xl:text-lg max-md:text-base'>Qr menü entegrasyonu için menünüzü iletin.</p>
            </li>
            <li className='flex items-center gap-2'>
          ...
          <a className='w-max px-7 py-2 rounded-xl font-semibold bg-[#8b38cb] text-white whitespace-nowrap xl:text-lg max-md:text-base mt-3' href="/iletisim">şimdi bilgi alın</a>
        </div>
      </div>
