...
const son = () => {
    return (
        <div className='flex justify-around items-center max-md:mb-4  mt-12'>
            <a title='Arlan Medya Qr menü sistemleri' href="/"> <img className='w-24 max-md:hidden' src="logobeyaz.webp" alt="Arlan Qr Menü Sistemleri" /></a>
            <p className='max-md:text-xs'>copyright <Link target='_blank' title='Arlan Medya' rel="nofollow"    href="https://www.arlanmedya.com/"><b>Arlan Medya</b></Link>  © 2021 Tüm Hakları Saklıdır.</p>
