...
const typeanimation = () => {
    return (
        <div className='text-white flex flex-col justify-center items-center  gap-5'>
            <p className='w-[580px] max-md:w-[85%] text-5xl font-fontum font-black max-md:text-3xl  text-center'>saniyeler içinde qr menünüz <br /> hazır!

                <span className='ml-3 text-4xl max-md:text-2xl'>
            ...
            <a className='px-7 py-2 rounded-lg font-semibold bg-[#514fe0] text-white whitespace-nowrap xl:text-lg' href="">bilgi alın</a>
